...
# Technical Guide on ChatGPT

The techical guide provides a deep dive on how ChatGPT works and how to use it effectively. 

- [How ChatGPT works: a deep dive](https://typefully.com/DanHollick/how-chatgpt-works-a-deep-dive-yA3ppZC)


# World Languages Supported by ChatGPT

ChatGPT has revolutionized the way we interact with computers and machines, allowing us to communicate more naturally than ever before. But while it’s great at understanding English, what about other languages? 

ChatGPT currently supports more than **50 languages**, including 
